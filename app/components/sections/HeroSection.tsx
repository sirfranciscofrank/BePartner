      ...
      <div className="relative mx-auto flex min-h-[65vh] max-w-7xl items-center gap-10 px-6 pt-8 pb-12">
        ...
        <div className="max-w-xl">
          ...
          <p className="mt-4 max-w-md text-[0.9375rem] leading-relaxed text-[var(--color-text-on-dark)]">
            <span className="font-semibold text-white">BePartner</span> helps
            Thai SMEs and corporates discover relevant suppliers, buyers,
            distributors, and partners — then connect when there&apos;s a{" "}
          ...
          <div className="mt-8 flex items-center gap-3">
            <div className="flex -space-x-2.5">
              <div className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-white/20 bg-[#38BDF8] text-sm font-bold text-[#0C2D48]">
                ส
              </div>
              <div className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-white/20 bg-[#FB923C] text-sm font-bold text-[#7C2D00]">
                K
              </div>
              <div className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-white/20 bg-[#4ADE80] text-sm font-bold text-[#052E16]">
                อ
              </div>
              <div className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-white/20 bg-[#A78BFA] text-sm font-bold text-[#2E1065]">
                P
              </div>
            </div>
